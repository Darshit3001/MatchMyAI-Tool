    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        startTransition(async () => {
            ...
            if (result?.error) {
                ...
                router.refresh(); // Refresh layout to show updated navbar
            }
        });
    };
        ...
        <div className="flex justify-center items-center min-h-[calc(100vh-4rem)] p-4 bg-surface-50 dark:bg-surface-900 border-x border-border/50">
            ...
            >
                <div className="clay-card rounded-2xl p-8 shadow-2xl relative overflow-hidden">
                    ...
                    <div className="absolute bottom-0 left-0 w-32 h-32 bg-secondary-500/10 rounded-full blur-3xl -ml-10 -mb-10" />
                    ...
                    <div className="relative z-10">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-text-500 dark:text-text-400">
                                Sign in to manage your AI toolkit
                            </p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div className="space-y-2">
                                <div className="flex justify-between items-center ml-1">
                                    <label className="text-sm font-medium text-text-700 dark:text-text-300">
                                        Password
                                    </label>
                        ...
                        <p className="mt-8 text-center text-sm text-text-500">
                            ...
                            <Link href="/register" className="font-medium text-primary-600 hover:text-primary-500 hover:underline">
                                Sign up for free
                            </Link>
                        </p>
                    </div>
